...
icon = Image.open(r"C:\Users\itech\Desktop.png")
st.set_page_config(page_title="Youtube Data Harvesting and Warehousing | By Harfa Mujawar",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This app is created by Harfa Mujawar!"""})
...
client = pymongo.MongoClient("mongodb+srv://Harfa:guvi1234@guvi.phjatuj.mongodb.net/?retryWrites=true&w=majority")
...
api_key = "AIzaSyDy2LAl5u8V6_-YN3w0W8F1SYpWRFqF4OM"
